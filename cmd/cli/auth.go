...
func doAuth() error {
	...
	err = copyFileFromTemplate("templates/views/login.jet.txt", cel.RootPath+"/views/login.jet")
	if err != nil {
		exitGracefully(err)
	}
	err = copyFileFromTemplate("templates/views/forgot.jet.txt", cel.RootPath+"/views/forgot.jet")
	if err != nil {
		exitGracefully(err)
	}
	err = copyFileFromTemplate("templates/views/reset-password.jet.txt", cel.RootPath+"/views/reset-password.jet")
	if err != nil {
		exitGracefully(err)
	}
